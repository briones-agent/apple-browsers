...
struct UserText {
    ...
    static let aiChatAttachMenuScreenshotScreensHeader = NSLocalizedString("aichat.attach-menu.screenshot.screens-header", value: "Screens", comment: "Section header inside the 'Take Screenshot' submenu listing each connected display the user can capture in one shot.")
    static let aiChatAttachMenuScreenshotWindowsHeader = NSLocalizedString("aichat.attach-menu.screenshot.windows-header", value: "Windows", comment: "Section header inside the 'Take Screenshot' submenu listing each currently-open application window the user can capture in one shot.")
