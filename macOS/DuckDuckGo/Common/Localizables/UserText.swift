...
struct UserText {
    ...
    static let aiChatModelPickerSubscriberExclusive = NSLocalizedString("aichat.model-picker.subscriber-exclusive", value: "Subscriber exclusive.", comment: "Label above the gated (subscriber-only) models in the model picker menu")
