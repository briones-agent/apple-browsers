...
enum ShortcutOption: String, CaseIterable, Identifiable, AppEnum {
    ...
    var icon: Image {
        ...
        case .duckAIVoice: return Image(uiImage: DesignSystemImages.Glyphs.Size24.microphone)
    ...
    var destination: URL {
        ...
        case .duckAIVoice: return DeepLinks.openAIChatVoice.appendingParameter(name: WidgetSourceType.sourceKey, value: WidgetSourceType.quickActions.rawValue)
