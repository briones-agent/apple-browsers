...
public struct UserText {
    ...
    public static let settingsKeepAddressBarVisible = NSLocalizedString("settings.appearance.keep.address.bar.visible", value: "Keep Address Bar Visible", comment: "Settings screen cell text for keeping the address bar and toolbar visible while scrolling on iPad")
