    ...
    public struct UserText {
        public enum BrowsersComparison {
            public enum Features {
                ...
                public static let privateAIChat = NotLocalizedString("Use ChatGPT privately with Duck.ai built in", comment: "Message to highlight browser capability of chatting with ChatGPT without sharing data with third parties")
