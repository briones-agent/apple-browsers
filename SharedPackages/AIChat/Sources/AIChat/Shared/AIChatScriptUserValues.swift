...
public struct AIChatNativePrompt: Codable, Equatable {
    ...
    public static func queryPrompt(_ prompt: String, autoSubmit: Bool, toolChoice: [String]? = nil, images: [NativePromptImage]? = nil, pageContext: AIChatPageContextData? = nil) -> AIChatNativePrompt {
        AIChatNativePrompt(platform: Platform.name, tool: .query(.init(prompt: prompt, autoSubmit: autoSubmit, toolChoice: toolChoice, images: images)), pageContext: pageContext)
    }
